...
return ( <div className="whatIDO"> <div className="what-box"> <h2 className="title">
W<span className="hat-h2">HAT</span> <div>
I<span className="do-h2"> DO</span> </div> </h2> </div>
    ...
    <div className="what-box-in">
      ...
      >
        ...
        <div className="what-content-in">
          ...
          <p>
            I uncover user needs, analyze behaviors, and transform
            insights into meaningful product experiences through
            research, user flows, and strategic thinking.
          </p>
      ...
      >
        ...
        <div className="what-content-in">
          ...
          <p>
            From visual systems to interactive prototypes, I create
            intuitive interfaces that balance aesthetics,
            usability, and meaningful user engagement.
          </p>
